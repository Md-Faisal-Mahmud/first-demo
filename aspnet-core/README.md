...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f18a9b93-c042-4218-91a6-3c27f68fba98
```

> `f18a9b93-c042-4218-91a6-3c27f68fba98` is the password of the certificate, you can change it to any password you want.
